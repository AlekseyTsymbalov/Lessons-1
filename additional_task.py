...
Student_Assessment.update(({sort_students[0]: yongling1, sort_students[1]: yongling2, sort_students[2]: yongling3, sort_students[3]: yongling4, sort_students[4]: yongling5}))
